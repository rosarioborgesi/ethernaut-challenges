...
contract Cashback layout at 0x442a95e7a6e84627e9cbb594ad6d8331d52abc7e6b6ca88ab292e4649ce5ba00 is ERC1155 {
    ...
    function accrueCashback(Currency currency, uint256 amount)
        ...
        onlyOnCashback
    {
        console.log("accrueCashback msg.sender", msg.sender);
        // console.log("accrueCashback address(this)", address(this));
    ...
    function payWithCashback(Currency currency, address receiver, uint256 amount)
        ...
        notOnCashback
    {
        // console.log("payWithCashback msg.sender", msg.sender);
        // console.log("payWithCashback address(this)", address(this));
    ...
    function consumeNonce() external onlyCashback notOnCashback returns (uint256) {
        // console.log("consumeNonce msg.sender", msg.sender);
        // console.log("consumeNonce address(this)", address(this));
        return ++nonce;
    }
